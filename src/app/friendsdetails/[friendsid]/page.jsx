...
const FriendDetails = async ({ params }) => {
  ...
  const friendInfo = getfriendsData.find(friend => friend.id == friendsid)
  const {id, name, picture, email,days_since_contact,status,tags,bio,goal,next_due_date} = friendInfo
  return (
    <>
